...
{
    class Tiquete : Empleado // Se llama a la clase padre conocido como Empleado
    {
        ...
        // Constructor
        public Tiquete(int id_ticket, int id_solicitud, int cedula_empleado, string id_estado, int hora_solicitud,
